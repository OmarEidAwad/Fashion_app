import 'package:fashion/core/theiming/colors.dart';
...
class TextStyles {
  ...
  static TextStyle font16PurpleMedium = TextStyle(
    fontSize: 16.sp,
    fontWeight: FontWeightHelper.medium,
    color: ColorsManager.mainPurple,
  );
  ...
  static TextStyle font16MorePurpleBold = TextStyle(
    fontSize: 16.sp,
    fontWeight: FontWeightHelper.bold,
    color: ColorsManager.morePurple,
  );
  static TextStyle font8PurpleBold = TextStyle(
    fontSize: 8.sp,
    fontWeight: FontWeightHelper.bold,
    color: ColorsManager.mainPurple,
  );
